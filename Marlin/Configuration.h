...
#define STRING_CONFIG_H_AUTHOR "(xgpt adapted from thisiskeithb, Ender-3)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99 } // longerlk2, 93 for ender3
...
//
#define CR10_STOCKDISPLAY // test test disablexgpt xgpt
